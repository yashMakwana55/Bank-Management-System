...
<!-- /End Fables Navigation --> 
    ...
    <!-- Start Header -->
    <div class="fables-header fables-after-overlay overlay-lighter bg-rules" style="background-image: url(assets/custom/images/bank-banner.jpg);">
    <div class="container overflow-hidden">  
        <div class="owl-carousel owl-theme default-carousel fables-sqr-nav dots-0 wow fadeInUpBig" data-wow-duration="2s">
              <div>
                  <h1 class="white-color bold-font mt-lg-5 mb-4">SECURE & RELIABLE BANKING <br> 
                     <span class="fables-second-text-color">FOR YOUR FINANCIAL NEEDS</span>
                  </h1>  
                  <p class="fables-third-text-color mt-3 mb-5 light-font fables-header-slider-details">
                      Manage your finances with ease. Our trusted banking services offer security, convenience, and reliability for all your banking needs.
                  </p>
                  <a href="account.jsp" class="btn fables-second-background-color fables-second-border-color white-color rounded-0 mr-4 px-md-4 py-2 btn-bg-hover white-color-hover">Open an Account</a>
                  <a href="#" class="btn fables-second-border-color white-color rounded-0 px-md-4 py-2 fables-second-hover-background-color">About Us</a>  
              </div> 
              <div>
                  <h1 class="white-color bold-font mt-lg-5 mb-4">SMART BANKING SOLUTIONS <br> 
                     <span class="fables-second-text-color">FOR A BETTER FUTURE</span>
                  </h1>  
                  <p class="fables-third-text-color mt-3 mb-5 light-font fables-header-slider-details">
                      Enjoy seamless banking with our digital solutions, secure transactions, and personalized financial services tailored to your needs.
                  </p>
